  ...
  render() {
    return (
      <form className="TimeForm TimeLog__row" onSubmit={this.handleSubmit}>
        <label>
          <input type="time" required value={this.state.start} onChange={this.handleChangeStart} />
          <span className="TimeLog__label">Start Time</span>
        </label>
        <label>
          <input type="time" required value={this.state.end} onChange={this.handleChangeEnd} />
